...
public interface MemberRepository extends JpaRepository<MemberEntity, Long> {
	...
	List<MemberEntity> searchByHname(@Param("name") String name);
	...
	@Query("""
			...
			""")
	List<MemberEntity> searchAvailableForShare(@Param("scheduleId") Long scheduleId, @Param("name") String name);
}
